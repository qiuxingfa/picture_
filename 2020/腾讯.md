...
31. [最小的k个数](https://github.com/qiuxingfa/picture_/blob/master/2020/腾讯.md#30-word2vec)
...
* XGBoost和GBDT的对比
  ...
  * GBDT在优化时只使用了一阶导数，而XGBoost对目标函数进行了二阶泰勒展开，此外XGBoost支持自定义损失函数，只要损失函数二阶可导
...
* self-attention
  ...
  * 假设Q和K都是独立的随机变量，满足均值为0，方差为1，则点乘后结果均值为0，方差为dk，也即方差会随维度dk的增大而增大，而大的方差导致极小的梯度，为了避免这种大方差带来的训练问题，论文中用内积除以维度的开方，使之变为均值为0，方差为1
...
* 二叉排序树（二叉搜索树）：空树或者左子树上所有节点的值均小于根节点，右子树所有节点 的值均大于根节点，中序遍历是一个递增数列
